...
const projectData = [
  {
    ...
    images: [
      { src: 'src/assets/media/hn/HN_landing_hero.png', caption: "Founder's vision executed" },
      { src: 'src/assets/media/hn/HN_products.png', caption: 'Much cleaner display of the products' },
      { src: 'src/assets/media/hn/HN_sale.png', caption: 'Discount pills and savings calculated' },
      { src: 'src/assets/media/hn/HN_footer.png', caption: 'Footer section to share the vision' }
  ...
  },
  {
    ...
    images: [
      { src: 'src/assets/media/orbitcoffee/orbitcoffee_mobile.jpeg', caption: "Get responsive design to work with custom icons and graphical assets designed by the Owner -- Site is no longer live, Orbit Coffee AU now operates explicity via their instagram page." },
      { src: 'src/assets/media/orbitcoffee/orbitcoffee_insta.png', caption: 'Scaling well on social media, surpassed the 300 followers milestone'},
    ],
  },
  {
    id: 'Coming soon',
    ...
    <>
      ...
      <div className={`flex flex-col min-h-screen font-sans transition-colors duration-500 ${darkMode ? 'bg-zinc-900 text-white bg-gradient-to-br from-zinc-900 to-black' : 'bg-gray-100 text-black bg-gradient-to-br from-gray-100 to-white'}`}>
        ...
        <section id="home" className="flex flex-col items-center p-8 md:p-24 pt-20 min-h-[70vh]">
          ...
          <div className="my-12">
            <img
              src="src\assets\media\profile_dp.jpeg"
              alt="Profile Picture"
